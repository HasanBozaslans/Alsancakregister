...
client.on("guildMemberAdd", async (member) => {
  ...
  ${Other.EmojiGeneral.Emoji6} • Soldaki \`Confirmation\` Odalarından Birine Geçerek Kaydolabilirsin.
  
  ${Other.EmojiGeneral.Emoji7} • Tagımızı Alarak \`${Settings.ServerSettings.Tag}\` BLACKSANCAK Ailemizin Bir Parçası Olabilirsin..`)
  .setColor("RANDOM")
